  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div
        ...
        className="absolute inset-0 bg-metis-ink/82 backdrop-blur-sm"
        onClick={onClose}
        onKeyDown={(event) => {
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          <label htmlFor="create-case-title" className="text-sm font-medium">
            Case Title *
          </label>
          <input
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows={3}
            className="metis-textarea w-full resize-none"
          />
        </div>

        <div className="space-y-2">
          <label htmlFor="create-case-priority" className="text-sm font-medium">
            Priority
          </label>
          <select
...
export function CreateEventDialog({
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          <label htmlFor="create-event-title" className="text-sm font-medium">
            Event Title *
          </label>
          <input
        ...
        <div className="space-y-2">
          <label htmlFor="create-event-type" className="text-sm font-medium">
            Event Type
          </label>
          <select
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          <label
            htmlFor="create-watchlist-description"
            className="text-sm font-medium"
          >
            Description
          </label>
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          <label htmlFor="create-task-type" className="text-sm font-medium">
            Task Type
          </label>
          <select
            id="create-task-type"
        ...
        <div className="space-y-2">
          <label htmlFor="create-task-priority" className="text-sm font-medium">
            Priority
          </label>
          <select
...
export function CreateNarrativeDialog({
  isOpen,
  onClose,
  onCreate,
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          <label
            htmlFor="create-narrative-title"
            className="text-sm font-medium"
          >
            Narrative Title *
          </label>
        ...
        <div className="space-y-2">
          <label
            htmlFor="create-narrative-description"
            className="text-sm font-medium"
          >
            Description
          </label>
