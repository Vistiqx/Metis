...
export function Alerts() {
  ...
  const highSeverityCount = mockAlerts.filter(
    (a) => a.severity === "high" && a.status === "unread",
  ).length;
          ...
          <div className="flex items-center gap-4">
            <div>
              ...
              <p className="metis-subtitle">
                Triage system findings with explicit state labels, case context,
                and analyst actions.
              </p>
            </div>
            {unreadCount > 0 && (
              <SignalBadge tone="anomaly">{unreadCount} unread</SignalBadge>
            )}
          </div>
